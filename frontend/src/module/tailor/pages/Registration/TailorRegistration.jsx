        ...
        switch (currentStep) {
                ...
                return (
                    <div className="space-y-8 lg:space-y-12 pb-6">
                        <div className="space-y-3">
                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 tracking-tighter uppercase italic leading-[0.9]">Identity<br /><span className="text-primary-600">Dossier</span></h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            <div className="md:col-span-2 space-y-4">
                                <p className="text-[10px] font-black text-primary-600 uppercase tracking-widest px-4 italic">Full Legal Address</p>
                                <textarea
                                    name="address"
                                    value={formData.address}
                                    onChange={handleInputChange}
                                    className="w-full p-6 bg-slate-50 border-none rounded-[2rem] ring-1 ring-slate-100 focus:ring-4 focus:ring-primary-100 outline-none transition-all font-bold text-slate-800 italic min-h-[140px] text-sm"
            ...
            case 2:
                return (
                    <div className="space-y-8 lg:space-y-12 pb-6">
                        <div className="space-y-3">
                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 tracking-tighter uppercase italic leading-[0.9]">KYC<br /><span className="text-primary-600">Verification</span></h2>
            ...
            case 3:
                return (
                    <div className="space-y-8 lg:space-y-12 pb-6">
                        <div className="space-y-3">
                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 tracking-tighter uppercase italic leading-[0.9]">Workshop<br /><span className="text-primary-600">Portfolio</span></h2>
                            <p className="text-slate-500 text-xs lg:text-sm font-medium italic">Upload photos of your finest stitching work (Min 3 photos).</p>
                        </div>
                        ...
                        <div className="p-8 bg-primary-50 rounded-[2rem] border border-primary-100 border-dashed">
                            <p className="text-[10px] text-primary-800 font-bold uppercase tracking-widest leading-relaxed italic text-center">
            ...
            case 4:
                return (
                    <div className="space-y-8 lg:space-y-12 pb-6">
                        <div className="space-y-3">
                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 tracking-tighter uppercase italic leading-[0.9]">Payout<br /><span className="text-primary-600">Settlement</span></h2>
                        </div>
                        <div className="bg-slate-900 p-8 lg:p-12 rounded-[2.5rem] lg:rounded-[3.5rem] shadow-2xl relative overflow-hidden group">
                            <div className="relative z-10 flex flex-col gap-12">
                                ...
                                <div className="space-y-2">
                                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">Registration ID</p>
                                    <p className="text-xl lg:text-2xl font-black text-white tracking-widest font-mono italic uppercase">MASTER-HUB-PENDING</p>
                                </div>
                            </div>
            ...
            case 5:
                return (
                    <div className="space-y-8 lg:space-y-12 pb-6">
                        <div className="space-y-3">
                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 tracking-tighter uppercase italic leading-[0.9]">Service<br /><span className="text-primary-600">Expertise</span></h2>
                            <p className="text-slate-500 text-xs lg:text-sm font-medium italic">Select the categories you're an absolute master in.</p>
                        </div>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
                            {[
            ...
            case 6:
                return (
                    <div className="space-y-8 lg:space-y-12 pb-6">
                        <div className="space-y-3">
                            <h2 className="text-3xl lg:text-5xl font-black text-slate-900 tracking-tighter uppercase italic leading-[0.9]">Workshop<br /><span className="text-primary-600">Timing</span></h2>
                        </div>
                        <div className="space-y-3">
                            {Object.keys(formData.schedule).map(day => (
                                <div key={day} className="bg-white p-5 lg:p-6 rounded-[1.5rem] lg:rounded-[2rem] border border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm hover:border-primary-100 transition-all">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <span className="capitalize font-black text-slate-800 text-sm tracking-widest uppercase italic">{day}</span>
                                    </div>
                                    <div className="flex items-center gap-4 w-full sm:w-auto">
                                        ...
                                        <span className="font-black text-slate-300 italic">—</span>
                        ...
                        <div className="p-8 bg-primary-50 rounded-[2.5rem] border border-primary-100 flex gap-6 items-center">
                            ...
                            <p className="text-primary-800 text-[10px] font-bold leading-relaxed italic uppercase">
            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-20">
                ...
                <div className="lg:w-80 shrink-0 space-y-8 lg:space-y-12 h-fit lg:sticky lg:top-24">
                    <div className="flex flex-row lg:flex-col items-center lg:items-start gap-4 lg:gap-8">
                        ...
                        <h1 className="text-xl lg:text-3xl font-black text-slate-900 tracking-tighter uppercase italic leading-none shrink-0">MASTER<br className="hidden lg:block" /><span className="text-primary-600">MANIFESTO</span></h1>
                    </div>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className={`text-[10px] lg:text-[11px] font-black uppercase italic ${currentStep === step.id ? 'text-slate-900 shadow-primary-500' : 'text-slate-400'}`}>
                                            {step.title}
                                        </p>
                                    </div>
                                </div>
...
const InputField = ({ label, type = "text", icon: Icon, ...props }) => (
    <div className="space-y-3">
        ...
        <input
            type={type}
            className="w-full p-5 lg:p-6 bg-slate-50 border-none rounded-[1.5rem] lg:rounded-[2rem] ring-1 ring-slate-100 focus:ring-4 focus:ring-primary-100 outline-none transition-all font-black text-slate-800 italic uppercase tracking-tighter text-sm md:text-base placeholder:opacity-40"
            {...props}
        />
    </div>
);
...
const FileUpload = ({ label, id }) => (
    <div className="p-8 bg-slate-50 border-2 border-dashed border-slate-100 rounded-[2.5rem] hover:border-primary-400 hover:bg-white transition-all group cursor-pointer text-center flex flex-col items-center justify-center gap-4 min-h-[180px]">
        ...
        <div>
            <span className="block font-black text-slate-800 uppercase tracking-tighter text-xs lg:text-sm italic">{label}</span>
